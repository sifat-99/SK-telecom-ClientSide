    ...
    <div>
      <footer className="footer p-10 bg-base-200 text-base-content">
        <nav>
          ...
          <button className="link link-hover">Buying</button>
          <button className="link link-hover">Service</button>
          <button className="link link-hover">Discount</button>
          <button className="link link-hover">Best</button>
        </nav>
        <nav>
          <header className="footer-title">Company</header>
          <button className="link link-hover">About us</button>
          <button className="link link-hover">Contact</button>
          <button className="link link-hover">Happy</button>
      ...
      <div>
        <footer className="footer items-center p-4 bg-base-200 text-neutral-content">
          <aside className="items-center grid-flow-col">
            ...
            <p>Copyright © 2023 - All right reserved to S.K telecom authority</p>
          </aside>
